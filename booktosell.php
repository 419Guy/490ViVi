...
<head>
        ...
        <style type="text/css">
        .panel-body {
	background:rgba(165, 160, 154, 0.5);
        }
		...
		<section class="body">
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
                     ...
                     <h1 style="text-align:center; color:#2e241a; font-weight:900; text-decoration:underline;">Add Your Book to Sell</h1>
							...
							<div class="col-xs-12">
								<section class="panel">
									<div class="panel-body">
										<form class="form-horizontal form-bordered" action="postbooksell.php" method="post">
                                        <div class="form-group">
												<div class="col-md-2">
                                                </div>
												<div class="col-md-8">
													<input type="text" class="form-control" name="title" id="Book Title" placeholder="Book Title" required="required">
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-8">
													<input type="text" class="form-control" name="isbn" id="isbn" placeholder="ISBN" required="required">
 ...
 <div class="form-group">
                ...
                <div class="col-md-12 text-center">
                        ...
                        <button type="submit"  class="btn btn-primary" name='pricecheck' formaction='book-info.php' formtarget='_blank'>Check Prices</button>
             ...
             <div class="form-group">
                ...
                <div class="col-md-8">
                        ...
                        <input type="text" class="form-control" id="Selling Price" name="price" placeholder="Selling Price" required="required">
						...
						<div class="form-group">
                                            ...
                                            <div class="form-group">
												<div class="col-md-6">
                                                <label style="font-size:20px; color:Black;">Return To Homepage ?</label>
                                                </div>
												<div class="col-md-6">
		

<button type="submit" formnovalidate formaction='postlogin.php' class="btn btn-primary">Return</button>
												</div>
											</div>
										</form>
									</div>
