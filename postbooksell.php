...
$query = "insert into booksale (id, username, title1, isbn, saleprice) values ('$loggedin_id','$loggedin_session', '$booktitle', '$isbn', '$price')";
...
?>
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
                     ...
                     <h1 style="text-align:center; color:#2e241a; font-weight:900; text-decoration:underline;">You have added your book</h1>
							...
							<div class="col-xs-12">
								<section class="panel">
									<div class="panel-body">
										<form class="form-horizontal form-bordered" action="booktosell.php">
                                        <div class="form-group">
												<div class="col-md-6">
                                                <label style="font-size:20px; color:Black;">Return To Sell Another Book?</label>
                                                </div>
												<div class="col-md-6">
													<a href="booktosell.php"><button type="submit" class="btn btn-primary">Return</button>
												</div>
											</div>
										</form>
									</div>
