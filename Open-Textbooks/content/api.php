...
//
//..where N is an ID.  Note that the division always has to be provided. even if the system in question doesn't have divisionas, the bookstore_functions code creates a placeholder
