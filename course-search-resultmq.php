           ...
           <a href="contact-us.php"><button class="btn btn-primary">Contact Us</button></a>
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
                     ...
                     <h1 style="text-align:center; color:#2e241a; font-weight:900; text-decoration:underline;">Courses Search Results</h1>
					<!-- start: page -->
						<div class="row">
							...
							<div class="col-xs-12">
								...
								<section class="panel">
									...
									<header class="panel-heading">
										...
										<h2 class="panel-title">Courses Search Results</h2>
									</header>
<?php
$client = new rabbitMQClient("coursesearch.ini","testServer");

        $request = array();
        $request['course'] = $_POST['course'];
    //    $loggedin_id = intval($loggedin_id);
  //      $request['id'] = $loggedin_id;
...
?>
 ...
 <?php
          if($response['returnCode'] == 1){
                echo "Sorry, we could not find the course you wanted\n";
        }else{
