				...
				<section role="main" class="content-body">
							...
							<div class="col-xs-12">
								<section class="panel">
									...
									<div class="panel-body" style="background-color:transparent;">
										<img src="assets/images/contact-us-image.png" class="img-responsive" />
                                        <div style="background-color:#b7b2ac; text-align:center; color:Black; height:100px;">
                                        <h3 style="padding:30px; font-weight:900;">Contact Us Information</h3>
					...
					<div class="table-responsive">
									<table class="table table-bordered table-striped table-condensed mb-none">
										<thead style="background-color:#8c001a; color:White;">
											<tr>
						            ...
						            <tbody>
											<tr>
												<td class="text-center">Aili Lim</td>
												<td class="text-center">al322@njit.edu</td>
												<td class="text-center">CEO</td>
											</tr>

											<tr>
												<td class="text-center">Jerome Bolante</td>
												<td class="text-center">jdb49@njit.edu</td>
												<td class="text-center">Sr. Software Developer</td>
											</tr>
						
						                    <tr>
												<td class="text-center">Alex Kwok</td>
												<td class="text-center">ak652@njit.edu</td>
												<td class="text-center">Sr. Systems Administrator</td>
											</tr>
						
						                    <tr>
												<td class="text-center">Nor Habboub</td>
												<td class="text-center">nkh6@njit.edu</td>
												<td class="text-center">Sr. Systems Analyst</td>
											</tr>
						            </tbody>
			                        </table>
